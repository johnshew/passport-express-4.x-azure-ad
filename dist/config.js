...
exports.redirectPath = 'auth/openid/return';
exports.port = process.env.PORT || '3000';
exports.loggingLevel = process.env.LOGGING_LEVEL || 'info';
exports.httpLogFormat = process.env.HTTP_LOG_FORMAT || 'dev';
console.log('config values', process.env.APP_ID, process.env.APP_SECRET, exports.baseUrl, exports.redirectPath, exports.port, exports.loggingLevel, exports.httpLogFormat);
exports.creds = {
    // Required
    ...
    redirectUrl: exports.baseUrl + exports.redirectPath,
...
if (!exports.creds.clientID || !exports.creds.clientSecret) {
